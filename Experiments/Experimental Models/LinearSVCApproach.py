...
custom_stop_words_list = []#['issue','problem','please','stop','solve','help','save']  # You can customize this list as needed
...
for repeated_time in range(REPEAT):
    ...
    # --- 4.3 LinearSVC model & GridSearch ---
...
print("=== Linear SVC + TF-IDF Results ===")
