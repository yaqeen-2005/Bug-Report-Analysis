...
custom_stop_words_list = ['issue','problem','please','stop','solve','help','save','thanks']  # You can customize this list as needed
...
out_csv_name = f'../{project}_MultinomialNB.csv'
